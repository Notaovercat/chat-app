  ...
  >
    <div class="w-11/12 rounded-md bg-white md:w-[700px]">
      ...
      <div class="flex justify-end">
        <div
          class="flex cursor-pointer select-text rounded-es-sm bg-rose-600 px-1 text-xs transition-all duration-200 hover:bg-red-500"
      ...
      <!-- LOGOUT -->
      <div class="m-2 flex items-end justify-end text-slate-50">
        <button
